...
class BuyStocksController:
    def __init__(self):
        self.router = APIRouter()

        # Register the routes
        self.router.post("/buy_stocks", response_model=PurchaseRecordResponse)(self.create_purchase_record)
        self.router.get("/buy_stocks", response_model=List[PurchaseRecordResponse])(self.get_purchases)
        self.router.get("/buy_stocks/{purchase_id}", response_model=PurchaseRecordResponse)(self.get_purchase)
        self.router.put("/buy_stocks/{purchase_id}", response_model=PurchaseRecordResponse)(self.update_buy_record)
        self.router.delete("/buy_stocks/{purchase_id}", response_model=dict)(self.delete_buy_record)
    ...
    async def create_purchase_record(
        ...
        net_profit = float(purchase_dict["price_per_unit"]) * float(purchase_dict["quantity"])
...
buy_stocks_controller = BuyStocksController()
router = buy_stocks_controller.router
